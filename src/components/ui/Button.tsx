...
export const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        primary:
          'bg-gradient-to-r from-primary via-primary-500 to-primary-600 text-primary-foreground shadow-soft hover:from-primary-600 hover:to-primary-700 hover:shadow-elevated',
        secondary:
